    ...
    <div class="wrapper">
        ...
        <div class="menu-order">
            <ul type="none">
                ...
                <li><a href="/getOrderByState/đã giao">Đã giao</a></li>
                <li><a href="/getOrderByState/đã hủy">Đã hủy</a></li>
                <li><a href="/getOrderByState/trả hàng-hoàn tiền">Trả hàng/hoàn tiền</a></li>
            </ul>
        </div>
        <form action="">
